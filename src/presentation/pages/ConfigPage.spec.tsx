...
vi.mock(import("../../domain/hooks/useGetCategories"), () => {
  return {
    __esModule: true,
    default: () =>
      ({
      ...
      }) as UseQueryResult<QuizCategoryModel[]>,
  };
});

vi.mock(import("../../domain/hooks/useGetDifficulties"), () => {
  return {
    __esModule: true,
    default: () =>
      ({
        data: [
          { label: "difficulty1", value: "easy" },
          { label: "difficulty2", value: "medium" },
          { label: "difficulty3", value: "hard" },
        ],
      }) as UseQueryResult<QuizDifficultyModel[]>,
  };
});

vi.mock(import("../../domain/hooks/useQuiz"), () => {
  return {
    __esModule: true,
    default: () => ({
